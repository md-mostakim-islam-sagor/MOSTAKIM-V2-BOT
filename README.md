...
<br />
<p align="center">
    <a href="https://github.com/md-mostakim-islam-sagor/MOSTAKIM-V2-BOT">
...
<p align="center">
  ...
  <a href="https://github.com/md-mostakim-islam-sagor/MOSTAKIM-V2-BOT/issues">
    <img src="https://img.shields.io/badge/Report-Bug-red?style=flat-square">
  </a>

  <a href="https://github.com/md-mostakim-islam-sagor/MOSTAKIM-V2-BOT/issues/new">
...
<p align="center">
  ...
  <img alt="size" src="https://img.shields.io/github/repo-size/md-mostakim-islam-sagor/MOSTAKIM-V2-BOT?style=flat-square&label=size">

  <img alt="bot-version" src="https://img.shields.io/badge/dynamic/json?color=red&label=bot%20version&prefix=v&query=%24.version&url=https%3A%2F%2Fraw.githubusercontent.com%2Fmd-mostakim-islam-sagor%2FMOSTAKIM-V2-BOT%2Fmain%2Fpackage.json&style=flat-square">

  <a href="https://github.com/md-mostakim-islam-sagor/MOSTAKIM-V2-BOT/commits/main">
    <img alt="commits" src="https://img.shields.io/github/commit-activity/m/md-mostakim-islam-sagor/MOSTAKIM-V2-BOT?label=commit&style=flat-square">
  </a>

  <img alt="visitors" src="https://visitor-badge.laobi.icu/badge?page_id=md-mostakim-islam-sagor.MOSTAKIM-V2-BOT&style=flat-square">
...
    ```sh
    git clone https://github.com/md-mostakim-islam-sagor/MOSTAKIM-V2-BOT.git
    ```
...
    ```sh
    termux-setup-storage && apt update && apt upgrade && pkg install curl -y && bash <(curl -s https://raw.githubusercontent.com/md-mostakim-islam-sagor/storage-data/master/install.sh)
    ```
...
<p align="center">
  ...
  <a href="https://github.com/md-mostakim-islam-sagor">
